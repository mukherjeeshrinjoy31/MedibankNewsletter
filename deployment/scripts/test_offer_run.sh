...
echo "=================================================="
echo "  Trigger Offer Runner ECS Task Manually"
echo "=================================================="
...
# ---- Run offer runner ECS task ----
echo ""
echo "Triggering Offer Runner ECS Fargate task..."
...
echo "  CloudWatch → Log Groups → $LOG_GROUP → ecs-offer/*"
echo ""
